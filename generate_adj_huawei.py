...
json_file_path = 'data/huawei-task-seq.json'
...
with open('data/sensor_graph/adj_mx_TG.pkl', 'wb') as f:
...
sensor_ids, sensor_id_to_ind, adj_mx = util.load_pickle('data/sensor_graph/adj_mx_TG.pkl')
print(sensor_ids)
print(sensor_id_to_ind)
print(adj_mx.shape)
# print(adj_mx)
